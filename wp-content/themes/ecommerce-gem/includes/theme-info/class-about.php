	...
	class eCommerce_Gem_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'ecommerce-gem-about', get_template_directory_uri() . '/includes/theme-info/css/about.css', array(), '2.1.5' );
				wp_enqueue_script( 'ecommerce-gem-about', get_template_directory_uri() . '/includes/theme-info/js/about.js', array( 'jquery' ), '2.1.5' );
				$js_vars = array(
